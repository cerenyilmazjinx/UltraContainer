// src/lib.rs
/*
 * Core library for UltraContainer
 */
...
#[derive(Debug)]
pub struct UltraContainerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UltraContainerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UltraContainer processing");
    
    let mut processor = UltraContainerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UltraContainerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UltraContainerProcessor::new(false);
